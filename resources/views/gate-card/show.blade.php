...
@section('button')
    @if ($gate_card->status_approval == 'draft')
    ...
    @endif
    <li class="nav-item mr-2">
        <a href="{{ url('/gate-card') }}" class="btn nav-link" style="color: red; border:1px solid red; background-color:white; ">Back</a>
    </li>
@endsection
@section('isi')
            ...
            <ul class="list-group list-group-flush " style="border-radius:15px;">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-sm-4 mt-sm-0 mt-1">
                            <div class="row align-items-center">
                                ...
                                <div class="col">
                                    {{ $gate_card->user->no_hp ?? '-' }}
                                    <a target="_blank" href="https://wa.me/{{ $gate_card->user->whatsapp($gate_card->user->no_hp) }}?text={{ url('/my-gate-card/show/'.$gate_card->id) }}" class="badge ml-2" style="color: rgb(4, 149, 50); border:1px solid rgb(4, 149, 50); background-color:white; "><i class="fab fa-whatsapp"></i> Whatsapp</a>
                                    <a target="_blank" href="tel:{{ $gate_card->user->no_hp }}" class="badge ml-2" style="color: gray; border:1px solid gray; background-color:white; "><i class="fas fa-phone-volume"></i> Call</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <li class="list-group-item">
                    <div class="row align-items-center">
                        ...
                        <div class="col-sm-2 font-weight-bold">Status Gate Card</div>
                        <div class="col-sm-4 mt-sm-0 mt-1">
                            <div class="row align-items-center">
                                <div class="col-1 d-none d-sm-inline">
                                    :
                ...
                <li class="list-group-item">
                    <div class="row align-items-center">
                        ...
                        <div class="col-sm-2 font-weight-bold">Jumlah Gate Card Yang Dipesan</div>
                        <div class="col-sm-4 mt-sm-0 mt-1">
                            <div class="row align-items-center">
                                <div class="col-1 d-none d-sm-inline">
                                    :
    ...
    <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <form action="{{ url('/gate-card/approval/'.$gate_card->id) }}" method="POST" enctype="multipart/form-data">
