                    ...
                    <div class="form-row">
                        <div class="col">
                            ...
                            <select name="type" id="type" class="form-control @error('type') is-invalid @enderror selectpicker" data-live-search="true">
                                ...
                                <option value="IWRT10101 - Keamanan" {{ 'IWRT10101 - Keamanan' == old('type') ? 'selected="selected"' : '' }}>IWRT10101 - Keamanan</option>
                                <option value="IWRT10102 - Sampah Rumah Tangga" {{ 'IWRT10102 - Sampah Rumah Tangga' == old('type') ? 'selected="selected"' : '' }}>IWRT10102 - Sampah Rumah Tangga</option>
                                <option value="IWRT10103 - Kebersihan" {{ 'IWRT10103 - Kebersihan' == old('type') ? 'selected="selected"' : '' }}>IWRT10103 - Kebersihan</option>
                                <option value="IWRT10104 - Token Listrik PJU" {{ 'IWRT10104 - Token Listrik PJU' == old('type') ? 'selected="selected"' : '' }}>IWRT10104 - Token Listrik PJU</option>
                                <option value="IWRT10105 - Sarana & Prasarana" {{ 'IWRT10105 - Sarana & Prasarana' == old('type') ? 'selected="selected"' : '' }}>IWRT10105 - Sarana & Prasarana</option>
                                <option value="IWRT10201 - Event" {{ 'IWRT10201 - Event' == old('type') ? 'selected="selected"' : '' }}>IWRT10201 - Event</option>
                                <option value="IWRT10202 - Dana Sosial" {{ 'IWRT10202 - Dana Sosial' == old('type') ? 'selected="selected"' : '' }}>IWRT10202 - Dana Sosial</option>
                                <option value="IWRT10203 - Inventaris" {{ 'IWRT10203 - Inventaris' == old('type') ? 'selected="selected"' : '' }}>IWRT10203 - Inventaris</option>
                                <option value="IWRT10204 - Rukun Kematian" {{ 'IWRT10204 - Rukun Kematian' == old('type') ? 'selected="selected"' : '' }}>IWRT10204 - Rukun Kematian</option>
                                <option value="IWRT10205 - Tak Terduga" {{ 'IWRT10205 - Tak Terduga' == old('type') ? 'selected="selected"' : '' }}>IWRT10205 - Tak Terduga</option>
                            </select>
                            @error('type')
