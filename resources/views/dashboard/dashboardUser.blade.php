            ...
            <ul class="box-service mt-3">
                ...
                <li>
                    <a href="{{ url('/my-kritik-saran') }}">
                        <div class="icon-box bg_service-4">
                            <img src="{{ asset('/assets/img/hand.png') }}" style="width: 30px">
                        </div>
                        Kritik & Saran
                    </a>
                </li>
